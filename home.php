...
// echo $_SESSION['user'];
// $logoutlink= "<a class=\"nav-link\" href=\"actions/logout.php?logout\">Logout</a>";
// echo $logoutlink;
// echo"whatever";
      	...
      	<div class="card border-dark mx-1 mb-4" style="max-width: 30vw;">
      		 	 ...
      		 	 <div class="card h-100 text-white bg-secondary">
      		 	 	<div class="card-header bg-dark align-middle">
							<h5><b><?= $row['type'] ?>
        					<span class="text-right" style="float: right"><a href="publish.php?publisher_name=<?= $row["publisher_name"]?>"><button class="btn btn-outline-light" type='button'><?= $row['publisher_name'] ?></button></a></span></b></h5>
        					</div>
