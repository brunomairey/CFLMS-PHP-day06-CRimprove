...
<form class="mx-5" action="actions/a_update.php" method= "post">
    ...
    <div class="form-group col-md-5 mr-5">
      ...
      <input type="text" class="form-control" name="author_name" value="<?php echo $data['author_name'] ?>">
    </div>
...
<div class="form-row col-md-12">
      ...
      <input type="number" class="form-control" name="ISBN" value="<?php echo $data['ISBN'] ?>" step="1">
    </div>
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="status">
       <option hidden><?php echo $data['status'] ?></option>
 ...
 <div class="form-group col-md-12">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="short_description"><?php echo $data['short_description']?></textarea>
  </div>
...
<div class="form-group col-md-12">
  ...
  <div class="form-row col-md-12">
    <div class="form-group col-md-5 mr-5">
      ...
      <input type="number" class="form-control" name="publisher_zip" value="<?php echo $data['publisher_zip'] ?>" step="1">
    </div>
    <div class="form-group col-md-5 ml-5">
    <label for="publisher_city">Publisher City</label>
    <input type="text" class="form-control" name="publisher_city" value="<?php echo $data['publisher_city'] ?>">
    </div>
  </div>
 <div class="form-row col-md-12">
     <div class="form-group col-md-5 mr-5">
      <label for="publisher_date">Publisher Date</label>
      <input type="date" class="form-control" name="publisher_date" value="<?php echo $data['publisher_date'] ?>">
    </div>
    <div class="form-group col-md-5 ml-5">
     <label for="publisher_size">Publisher size</label>
    <select class="form-control" id="exampleFormControlSelect1" name="publisher_size">
      <option hidden><?php echo $data['publisher_size'] ?></option>
      <option>small</option>
  ...
  <button type="submit" class="btn btn-dark mr-5">Edit Media</button>
   <a class="btn btn-dark" href="index.php" type="button" role="button">
    Back to main Page
  </a>
</div>
</form>
